...
$string['reissue_success'] = '<p>Das Zertifikat für: <b>{$a}</b> wurde erfolgreich neuausgestellt.</p><br/>';
$string['registered_and_signed'] = 'Das Zertifikat ist in der Blockchain erfolgreich registriert und signiert worden.';
