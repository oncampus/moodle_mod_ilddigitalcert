...
$string['auto_certifier_help'] = 'Geben Sie hier einen Zertifizierer an, in dessen/deren Namen die Zertifikate automatisiert signiert werden sollen. Geeignete Zertifizierer müssen in diesem Kurs eingeschrieben sein und bereits eine gültige Blockchain-Adresse haben.';
...
$string['block_summary'] = '<p>Überprüfen Sie hier die Echtheit Deiner digitalen Zertifikate.</p>
<p>Ziehen Sie dazu einfach Ihr Zertifikat (PDF, XML oder BCRT-Datei) per Drag and Drop in das Feld.</p>
<p>Ihre ausgedruckte Version des Zertifikates können Sie überprüfen indem Sie
den untenstehenden QR-Code einscannen.
</p>';
...
$string['dcconnectoraddress'] = 'Connector-Adresse';
...
$string['issuedcerts_report:contexturlname'] = 'Signieren Sie die ausgestellten Zertifikate';
...
$string['mycertificates'] = 'Ihre Zertifikate';
