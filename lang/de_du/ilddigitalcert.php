...
<p>folgende Zertifikate wurden kürzlich automatisch in deinem Namen signiert und erfolgreich in die Blockchain geschrieben:</p>';
$string['automation_report:other_certs'] = 'Andere Zertifikate';
$string['automation_report:subject'] = 'Automatisch signierte Zertifikate';

$string['auto_certifier'] = 'Zertifizierer';
$string['auto_certifier_help'] = 'Gib hier einen Zertifizierer an, in dessen/deren Namen die Zertifikate automatisiert signiert werden sollen. Geeignete Zertifizierer müssen in diesem Kurs eingeschrieben sein und bereits eine gültige Blockchain-Adresse haben.';
$string['auto_pk'] = 'Privater Schlüssel des Zertifizierers';
$string['auto_pk_help'] = 'Gib hier den privaten Schlüssel des oben angegebenen Zertifizierers an.';
...
$string['body_new_attribute'] = 'Mit dieser Nachricht erhälts Du ein neues Attribut für die Vervollständigung deiner persönlichen Daten.';
...
$string['error_choose'] = 'Wähle eine Zertifizierungsstelle';
$string['error_choose_certifier'] = 'Wähle eine:n Zertizierer:in';
...
<p>folgende Zertifikate wurden kürzlich ausgestellt. Bitte signiere diese über die folgenden Schaltflächen:</p>';
...
$string['subject_certificate_revoked'] = 'Dein Zertifikat wurde wiederrufen';
...
<p>Dein digitales Zertifikat wurde wiederrufen.</p>
<p>Hier kannst Du dir dein Zertifikat ansehen: <a href="{$a->url}">{$a->url}</a>.</p>
<p>Viele Grüße</p>
<p>Dein {$a->from} Team</p>';
$string['message_new_certificate_html'] = '<p>Hallo {$a->fullname},</p>
<p>Du hast ein digitales Zertifikat erhalten.</p>
<p>Hier kannst Du dir dein Zertifikat ansehen: <a href="{$a->url}">{$a->url}</a>.</p>
<p>Viele Grüße</p>
<p>Dein {$a->from} Team</p>';
$string['message_new_digital_certificate_html'] = '<p>Hallo {$a->fullname},</p>
<p>Dein digitales Zertifikat wurde in der Blockchain registriert und signiert.</p>
<p>Hier kannst Du dir dein Zertifikat ansehen: <a href="{$a->url}">{$a->url}</a>.</p>
<p>Viele Grüße</p>
<p>Dein {$a->from} Team</p>';
$string['message_generate_pk'] = 'Hallo {$a->fullname},

Du wurdest als neuer Zertifizierer auf {$a->url} hinzugefügt.

Um digitale Zertifikate in der Blockchain zu registrieren und zu signieren, benötigst du einen Private Key.

Deinen persönlichen Private Key kannst Du dir unter folgendem Link generieren.
...
<p>&nbsp;</p>
<p>Du wurdest als neuer Zertifizierer auf {$a->url} hinzugefügt.</p>
<p>&nbsp;</p>
<p>Um digitale Zertifikate in der Blockchain zu registrieren und zu signieren, benötigst Du einen Private Key</p>
<p>&nbsp;</p>
<p>Deinen persönlichen Private Key kannst Du dir unter folgendem Link generieren.</p>
<p>&nbsp;</p>
<p><a href="{$a->token_link}">{$a->token_link}</a></p>
<p>&nbsp;</p>
<p>Viele Grüße</p>
<p>Dein {$a->from} Team</p>';
$string['message_sendtowallet_subject'] = 'Dein digitales Zertifikat';
$string['message_sendtowallet_body'] = 'Im Anhang dieser Nachricht erhältst Du dein digitales Zertifikat zur weiteren Verwendung. Du findest es außerdem im Ordner Dateien.';
...
Du wurdest als neuer Zertifizierer für die Zertifizierungsstelle "{$a->institution}" auf {$a->url} hinzugefügt.

Viele Grüße
{$a->from}';
$string['new_certifier_message_html'] = '<p>Hallo {$a->fullname}</p>
<p>&nbsp;</p>
<p>Du wurdest als neuer Zertifizierer für die Zertifizierungsstelle "{$a->institution}" auf {$a->url} hinzugefügt.</p>
<p>&nbsp;</p>
<p>Viele Grüße</p>
<p>{$a->from}</p>';
...
Um Zertifikate in der Blockchain registrieren und zu signieren, verwende bitte folgenden Private Key:
{$a->pk}

Bewahre deinen Private Key sicher auf und gebe ihn nicht weiter! Weitere Informationen zu diesem Thema findest Du hier: https://www.oncampus.de/private_key
...
<p>Du wurdest als neuer Zertifizierer für die Zertifizierungsstelle "{$a->institution}" auf {$a->url} hinzugefügt.</p>
<p>&nbsp;</p>
<p>Um Zertifikate in der Blockchain registrieren und zu signieren, verwende bitte folgenden Private Key:</p>
<p>{$a->pk}</p>
<p>&nbsp;</p>
<p>Bewahre deinen Private Key sicher auf und gebe ihn nicht weiter! Weitere Informationen zu diesem Thema findest Du hier: https://www.oncampus.de/private_key</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>Viele Grüße</p>
<p>{$a->from}</p>';
$string['new_certifier_subject'] = 'Du wurdest als Zertifizierer hinzugefügt';
$string['new_pk_generated'] = '<p>Herzlichen Glückwunsch!</p>
<p>Für dich wurde ein neuer Private Key erstellt.</p>
<p>Dein Private Key: {$a->pk}</p>
<p>Behandel deinen Private Key wie ein wichtiges Passwort und gebe ihn nicht weiter.</p>
<p>Mit Ihrem Private Key registrierst und signierst Du Digitale Zertifikate in der Blockchain.</p>
<p>Schließe diese Seite nicht und lade sie nicht neu, bevor Du deinen Private Key gesichert hast!</p>';
...
Kontrolliere bitte ob Du korrekt angemeldet bist.';
$string['not_installed_correctly'] = 'Das Plugin "Digitale Zertifikate" wurde nicht vollständig installiert.
Lese die Datei README.md oder wende dich an den Moodle Administrator';
$string['not_logged_in'] = 'Du bist nicht im System angemeldet.';
$string['only_blockchain'] = 'Registrierte Zertifikate';
$string['only_nonblockchain'] = 'Unregistrierte Zertifikate';
$string['overview'] = 'Deine erworbenen Zertifikate';
...
$string['reissue_confirmation'] = 'Willst du die folgenden Zertifikate neuausstellen?';
...
$string['revoke_confirmation'] = 'Willst du folgende Zertifikate wiederrufen?';
...
$string['scan_qr_code'] = 'Um dein digitales Zertifikat an die Wallet zu senden, musst Du erst eine Verbindung zu dieser herstellen. Öffne dazu die App und scanne den QR-Code. Folge anschließend den Anweisungen in der App.';
$string['select_user'] = 'Wähle eine/n Nutzer/in aus!';
...
$string['send_certificate_to_wallet'] = 'Sende dein digitales Zertifikat jetzt an deine Wallet. Anschließend kannst Du es in der App auf dem Smartphone verwenden und mit anderen Institutionen teilen.';
$string['send_certificate_to_wallet_success'] = 'Das Zertifikat wurde an deine Wallet gesendet. Du kannst es nun in der App auf Ihrem Smartphone verwenden.';
...
$string['sign_confirmation'] = 'Willst Du folgende Zertifikate signieren und registrieren?';
...
$string['subject_generate_pk'] = 'Generiere deinen Private Key als Zertifizierer';
...
$string['verify_authenticity_descr'] = 'Um die Gültigkeit des Zertifikates zu überprüfen, lade die PDF-Datei unter
<a href="{$a->url}">{$a->url}</a> hoch.
<br />Deine ausgedruckte Version des Zertifikates kannst Du überprüfen indem Du nebenstehenden QR-Code einscannst.';
$string['verify_description'] = 'Überprüfe hier deine digitalen Zertifikate in der Blockchain';
...
$string['wrong_relationship'] = 'Die Verbindung deiner Wallet mit dem System ist fehlerhaft. Bitte wende dich an einen Administrator.';
