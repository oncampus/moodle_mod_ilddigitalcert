...
/**
 * Event triggered after a certificate is issued to a user.
 *
 * @package    mod_ilddigitalcert
 * @copyright  2022 ISy TH Lübeck <dev.ild@th-luebeck.de>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class certificate_issued extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcertificateissued', 'mod_ilddigitalcert');
    }
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has been issued the certificate with id '".$this->objectid."'.";
    }
