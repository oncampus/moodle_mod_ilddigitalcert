...
/**
 * Event triggered after a certificate is revoked by a user.
 *
 * @package    mod_ilddigitalcert
 * @copyright  2022 ISy TH Lübeck <dev.ild@th-luebeck.de>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class certificate_revoked extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcertificaterevoked', 'mod_ilddigitalcert');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' revoked the certificate with id '".$this->objectid."'.";
    }
